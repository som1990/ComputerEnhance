...
def disassemble_CPU8086(bin_path: str)->str:
    ...
    while (count > -1):
        ...
        try:
            ...
            output, buff_off, sim_out = opcode_func(bin_data, buff_off, registers)
            out_file += str(output) + '\n'
            out_op_text += sim_out
...
#path =os.path.join(dirname, 'listing_0043_immediate_movs')
#path =os.path.join(dirname, 'listing_0044_register_movs')

#path =os.path.join(dirname, 'listing_0045_challenge_register_movs')
